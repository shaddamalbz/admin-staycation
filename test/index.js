...
describe("API Endpoint Testing", () => {
  ...
  it("POST Booking Page", (done) => {
    const image = __dirname + "/kucing.png";
    const dataSample = {
      image,
      ...
      firstName: "boom",
      lastName: "bam",
      email: "bombam@gmail.com",
      phoneNumber: "081237765289",
      accountHolder: "Boom bam",
      bankFrom: "BNI",
    };
    chai
      .request(app)
      ...
      .attach("image", fs.readFileSync(dataSample.image), "kucing.png")
      .end((err, res) => {
        expect(err).to.be.null;
